    ...
    return `
        <div class="cooling-start-form">
            ...
            <div style="margin-top:16px;padding:12px;background:#e8f4f8;border:1px solid #b3d9e6;border-radius:8px;">
                <div style="font-weight:700;font-size:13px;color:#0c5460;margin-bottom:6px;">ℹ️ 3-timers regel</div>
                <div style="font-size:12px;color:#0c5460;line-height:1.5;">
                    Fødevaren skal nedkøles fra minimum <strong>65°C til maksimum 10°C</strong> inden for <strong>3 timer (180 minutter)</strong>.
