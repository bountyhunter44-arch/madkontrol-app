...
- `/modules/pos/index.html` - kasse, kurv, rabat, betalingsvalg og bon-print.
- `/modules/pos/create-product.html` - opret produkter med pris inkl. moms, kategori og billede-URL.
- `/modules/pos/edit-product.html` - ret varenavn, pris inkl. moms, kategori og billede-URL.
- `/modules/pos/delete-product.html` - slet/inaktiver produkter i Firestore.
- `/modules/pos/sales-report.html` - dagens salg, moms, kasseafstemning, betalingsafstemning og revisorpakke.
...
Den ligger i `functions/modules/pos/product-images.js` og bruger:
