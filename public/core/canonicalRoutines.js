...
export const CANONICAL_ROUTINES = [
  ...
  },
  {
    ...
    subtitle: "Temperaturkontrol af ismaskine",
    ...
    howToCheck: "Kontrollér at isen fremstår fast, ren og uden tegn på optøning eller forurening.",
    acceptCriteria: "Isen fremstår fast, ren og uden tegn på optøning eller forurening.",
    risk: {
  ...
  },
  {
    ...
    frequencyDays: 7,
    controlType: "cleaning",
    subtitle: "Rengøring af ismaskine",
    longDescription: "Rengør ismaskinen efter producentens anvisninger. Områder med kontakt til is og vand skal holdes rene.",
    howToCheck: "Kontrollér at isbakke, indvendige flader og relevante kontaktflader er rene.",
    acceptCriteria: "Isbakke, indvendige flader og relevante kontaktflader er rene.",
    risk: {
  ...
  },
  {
    ...
    frequencyDays: 1,
    controlType: "temperature",
    subtitle: "Temperaturkontrol af softicemaskine",
    longDescription: "Kontrollér at softicemaskinens temperatur er inden for producentens anbefalede område.",
    howToCheck: "Kontrollér temperaturdisplay eller måling efter virksomhedens procedure.",
    acceptCriteria: "Softicemaskinens temperatur er inden for producentens anbefalede område.",
    risk: {
  ...
  },
  {
    ...
    frequencyDays: 7,
    controlType: "cleaning",
    subtitle: "Rengøring af softicemaskine",
    ...
    purpose: "At sikre, at softicemaskinen rengøres og desinficeres korrekt efter plan og producentens anvisning.",
    checkItems: [
...
export function normalizeRoutineType(input) {
  if (!input) return "";
...
export function buildCanonicalTaskKey(routineType, unitId) {
...
export function buildDisplayTitle(definitionOrTask, unitOrName = null) {
...
export function getRoutineDefinition(routineType) {
  const normalizedRoutineType = normalizeRoutineType(routineType);
