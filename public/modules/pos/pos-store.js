...
import { getBusinessSnapshotFromContext, resolvePlatformContext } from "./context-provider.js";
...
export async function createPosStore(options = {}) {
  ...
  const context = await resolvePlatformContext({ sourceApp: options.sourceApp || "pos", user }).catch((error) => {
