/**
 * riskToRoutineTransformer.js (Backend Node.js version)
 * 
 ...
 */
function buildRoutineCardsFromRiskCards(riskCards = []) {
  const routineCards = [];
 ...
 */
function mapControlToRoutine(card, control) {
  // 1. Varemodtagelse
  if (control === "Varemodtagelse") {
    return {
      riskCardId: card.id || card.key,
...
module.exports = {
  buildRoutineCardsFromRiskCards,
  mapControlToRoutine
};
