...
const GUIDE_LIBRARY = {
    ...
    separation_control: {
        ...
        version: "1.0",
        title: "Adskillelse af rå og tilberedte fødevarer",
        purpose: "Forebygge krydskontaminering mellem rå og tilberedte eller spiseklare fødevarer",
        whenToUse: "Daglig kontrol af opbevaring og tilberedning",
        equipment: "Visuel inspektion, separate skærebrætter og knive",
        steps: [
            "Kontrollér at rå kød, fjerkræ og fisk er adskilt fra tilberedte varer i køl",
            "Tjek at rå varer opbevares under tilberedte varer i køleskabet",
            "Verificér at separate skærebrætter og redskaber bruges til råvarer",
            "Kontrollér at emballage på rå varer er intakt og ikke lækker",
            "Tjek at personale skifter handsker og vasker hænder ved skift mellem rå og tilberedte varer"
        ],
        deviationSteps: [
            "Kassér tilberedte varer der kan have været i kontakt med råvarer",
            "Adskil og mærk straks ved fejlplacering",
            "Instruer personale i korrekt adskillelsespraksis",
            "Dokumentér hændelse og korrigerende handling"
        ],
        documentation: "Registrér kontrol og eventuelle fund eller korrigerende handlinger"
    },

    three_hour_rule: {
        key: "three_hour_rule",
        version: "1.0",
        title: "3-timers regel – fødevarer uden temperaturkontrol",
        purpose: "Sikre at fødevarer ikke udsættes for bakterievækst i farezone (8–65°C) i mere end 3 timer",
        whenToUse: "Dagligt ved servering, buffet eller eksponering af fødevarer uden aktiv køl/varme",
        equipment: "Ur/timer, termometer",
        steps: [
            "Registrér tidspunkt for at fødevaren sættes frem",
            "Kontrollér at max 3 timer overholdes fra produktion til bortskaffelse eller opbevaring",
            "Mål temperatur inden for de 3 timer hvis muligt",
            "Fjern og kassér varer der overstiger 3-timers grænsen",
            "Dokumentér tidspunkt og handling"
        ],
        deviationSteps: [
            "Kassér varer der har stået for længe i farezonen",
            "Juster produktionsmængde for at undgå spild",
            "Instruer personale i tidsgrænsen",
            "Dokumentér kassering og årsag"
        ],
        documentation: "Registrér tidspunkter og evt. kassering"
    },
    ...
    close_day: {
        ...
        version: "1.0",
        title: "Luk dag",
        purpose: "Sikre at alle dagens egenkontrolregistreringer er afsluttet og underskrevet",
        whenToUse: "Sidst på arbejdsdagen, inden lokationen lukker",
        equipment: "Tjekliste, eventuel tablet",
        steps: [
            "Gennemgå at alle dagens kontrolopgaver er udfyldt",
            "Kontrollér at afvigelser er dokumenteret og håndteret",
            "Tjek at fødevarer er korrekt opbevaret til næste dag",
            "Verificér at rengøring er udført i henhold til plan",
            "Afslut og godkend dagens egenkontrol i systemet"
        ],
        deviationSteps: [
            "Fuldfør manglende registreringer inden lukning",
            "Dokumentér årsag til manglende opgaver",
            "Informer ansvarlig ved kritiske mangler",
            "Følg op næste dag"
        ],
        documentation: "Bekræft at alle dagens registreringer er fuldt udfyldt"
    }
};
...
function mapCategoryToGuideKey(aggregatedCategory) {
    const mapping = {
        ...
        "cooking_control": "hot_preparation_core_temperature",
        "separation_control": "separation_control",
        "three_hour_rule": "three_hour_rule",
        "close_day": "close_day",
...
function mapCategoryToTaskType(aggregatedCategory) {
    const mapping = {
        ...
        "ice_equipment_critical": "ice_equipment",
        "fryer_critical": "fryer_control",
        "cooking_control": "cooking_control",
        "separation_control": "separation_control",
        "three_hour_rule": "three_hour_rule",
        "close_day": "close_day",
        "cooling_process": "cooling_process",
